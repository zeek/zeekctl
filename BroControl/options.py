...
options = [
    ...
    Option("CompressCmd", "gzip -9", "string", Option.USER, False,
           "If archived logs will be compressed, the command to use to compress the archived log files. The specified command must compress its standard input to standard output."),
