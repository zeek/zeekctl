...
def printPlugin():
    print(doc.printClass(plugin.Plugin, tag="no-methods"), end="")
    print(doc.printClass(plugin.Plugin, header=False), end="")
    print(doc.printClass(plugin.Plugin, "override", header=False), end="")

    print(doc.printClass(node.Node), end="")
