...
"""
    ...
    # If the directory doesn't exist, then there's nothing to do.
    ...
    # If no files were found, then there's nothing to do.
    if not certs:
        return

    util.output("converting certs ...", False)

    s = "# Don't edit!  This file is automatically generated."
    for cert in certs:
